...
function isPrimitive(value) {
  return isStatic(value) || typeofvalue === 'symbol'
}
...
function isFunction(value) {
  returnObject.prototype.toString.call(value) === '[object Function]'
}
...
//运行环境是浏览器
let inBrowser = typeofwindow !== 'undefined'
//运行环境是微信
...
//repeat('123',3) ==> 12312312328、dateFormater：格式化时间
...
// dateStrForma('20190626', 'YYYYMMDD', 'YYYY年MM月DD日') ==> 2019年06月26日// dateStrForma('121220190626', '----YYYYMMDD', 'YYYY年MM月DD日') ==> 2019年06月26日// dateStrForma('2019年06月26日', 'YYYY年MM月DD日', 'YYYYMMDD') ==> 20190626
// 一般的也可以使用正则来实现//'2019年06月26日'.replace(/(d{4})年(d{2})月(d{2})日/, '$1-$2-$3') ==> 2019-06-26
// 30、getPropByPath：根据字符串路径获取对象属性 : 'obj[0].count'

function getPropByPath(obj, path, strict) {
  let tempObj = obj
  path = path.replace(/[(w+)]/g, '.$1') //将[0]转化为.0 path = path.replace(/^./, ''); //去除开头的.
...
} //min([1, 2, '11', null, 'fdf', []]) ==> 139、random：返回一个lower - upper之间的随机数
...
} //random(0, 0.5) ==> 0.3567039135734613//random(2, 1) ===> 1.6718418553475423//random(-2, -1) ==> -1.447432545236194540、Object.keys：返回一个由一个给定对象的自身可枚举属性组成的数组
...
document.addEventListener('keydown', function(event) {
  return (
    !(
      112 == event.keyCode || //F11
      23 == event.keyCode || //F12
